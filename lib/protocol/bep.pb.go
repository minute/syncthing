...
const (
	...
	messageTypeEncryptedIndex       MessageType = 8
	messageTypeEncryptedIndexUpdate MessageType = 9
	messageTypeEncryptedRequest     MessageType = 10
	messageTypeEncryptedResponse    MessageType = 11
)
...
type EncryptedIndex struct {
	Folder string              `protobuf:"bytes,1,opt,name=folder,proto3" json:"folder,omitempty"`
	Files  []EncryptedFileInfo `protobuf:"bytes,2,rep,name=files" json:"files"`
}

func (m *EncryptedIndex) Reset()                    { *m = EncryptedIndex{} }
func (m *EncryptedIndex) String() string            { return proto.CompactTextString(m) }
func (*EncryptedIndex) ProtoMessage()               {}
func (*EncryptedIndex) Descriptor() ([]byte, []int) { return fileDescriptorBep, []int{11} }
...
func (m *EncryptedIndexUpdate) Reset()                    { *m = EncryptedIndexUpdate{} }
func (m *EncryptedIndexUpdate) String() string            { return proto.CompactTextString(m) }
func (*EncryptedIndexUpdate) ProtoMessage()               {}
func (*EncryptedIndexUpdate) Descriptor() ([]byte, []int) { return fileDescriptorBep, []int{12} }

type EncryptedFileInfo struct {
	Identifier        string `protobuf:"bytes,1,opt,name=identifier,proto3" json:"identifier,omitempty"`
	EncryptedFileinfo []byte `protobuf:"bytes,2,opt,name=encrypted_fileinfo,json=encryptedFileinfo,proto3" json:"encrypted_fileinfo,omitempty"`
...
func (m *EncryptedFileInfo) Reset()                    { *m = EncryptedFileInfo{} }
func (m *EncryptedFileInfo) String() string            { return proto.CompactTextString(m) }
func (*EncryptedFileInfo) ProtoMessage()               {}
func (*EncryptedFileInfo) Descriptor() ([]byte, []int) { return fileDescriptorBep, []int{13} }
...
func (*Request) Descriptor() ([]byte, []int) { return fileDescriptorBep, []int{14} }
...
func (m *EncryptedRequest) Reset()                    { *m = EncryptedRequest{} }
func (m *EncryptedRequest) String() string            { return proto.CompactTextString(m) }
func (*EncryptedRequest) ProtoMessage()               {}
func (*EncryptedRequest) Descriptor() ([]byte, []int) { return fileDescriptorBep, []int{15} }
...
func (*Response) Descriptor() ([]byte, []int) { return fileDescriptorBep, []int{16} }

type EncryptedResponse struct {
	ID    int32     `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	Data  []byte    `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
	Nonce []byte    `protobuf:"bytes,3,opt,name=nonce,proto3" json:"nonce,omitempty"`
	Code  ErrorCode `protobuf:"varint,4,opt,name=code,proto3,enum=protocol.ErrorCode" json:"code,omitempty"`
}

func (m *EncryptedResponse) Reset()                    { *m = EncryptedResponse{} }
func (m *EncryptedResponse) String() string            { return proto.CompactTextString(m) }
func (*EncryptedResponse) ProtoMessage()               {}
func (*EncryptedResponse) Descriptor() ([]byte, []int) { return fileDescriptorBep, []int{17} }
...
func (*DownloadProgress) Descriptor() ([]byte, []int) { return fileDescriptorBep, []int{18} }
...
func (*FileDownloadProgressUpdate) Descriptor() ([]byte, []int) { return fileDescriptorBep, []int{19} }
...
func (*Ping) Descriptor() ([]byte, []int) { return fileDescriptorBep, []int{20} }
...
func (*Close) Descriptor() ([]byte, []int) { return fileDescriptorBep, []int{21} }
...
func init() {
	...
	proto.RegisterType((*EncryptedIndex)(nil), "protocol.EncryptedIndex")
	proto.RegisterType((*EncryptedIndexUpdate)(nil), "protocol.EncryptedIndexUpdate")
	proto.RegisterType((*EncryptedFileInfo)(nil), "protocol.EncryptedFileInfo")
	proto.RegisterType((*Request)(nil), "protocol.Request")
	proto.RegisterType((*EncryptedRequest)(nil), "protocol.EncryptedRequest")
	proto.RegisterType((*Response)(nil), "protocol.Response")
	proto.RegisterType((*EncryptedResponse)(nil), "protocol.EncryptedResponse")
...
func (m *EncryptedIndex) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *EncryptedIndex) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *EncryptedIndexUpdate) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *EncryptedIndexUpdate) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *EncryptedFileInfo) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *EncryptedFileInfo) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Identifier) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintBep(dAtA, i, uint64(len(m.Identifier)))
		i += copy(dAtA[i:], m.Identifier)
	}
	if len(m.EncryptedFileinfo) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintBep(dAtA, i, uint64(len(m.EncryptedFileinfo)))
		i += copy(dAtA[i:], m.EncryptedFileinfo)
	}
	if len(m.Nonce) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintBep(dAtA, i, uint64(len(m.Nonce)))
		i += copy(dAtA[i:], m.Nonce)
	}
	if m.NumBlocks != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintBep(dAtA, i, uint64(m.NumBlocks))
	}
	dAtA[i] = 0x2a
	i++
	i = encodeVarintBep(dAtA, i, uint64(m.Version.ProtoSize()))
...
func (m *EncryptedRequest) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *EncryptedRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.BlockNumber != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintBep(dAtA, i, uint64(m.BlockNumber))
	}
	return i, nil
}
...
func (m *EncryptedResponse) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *EncryptedResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *EncryptedIndex) ProtoSize() (n int) {
	var l int
	_ = l
	l = len(m.Folder)
	if l > 0 {
...
func (m *EncryptedIndexUpdate) ProtoSize() (n int) {
	var l int
	_ = l
	l = len(m.Folder)
	if l > 0 {
...
func (m *EncryptedFileInfo) ProtoSize() (n int) {
	var l int
	_ = l
	l = len(m.Identifier)
	if l > 0 {
...
func (m *EncryptedRequest) ProtoSize() (n int) {
	var l int
	_ = l
	if m.ID != 0 {
		n += 1 + sovBep(uint64(m.ID))
	...
	if m.BlockNumber != 0 {
		n += 1 + sovBep(uint64(m.BlockNumber))
	}
	return n
}
...
func (m *EncryptedResponse) ProtoSize() (n int) {
	var l int
	_ = l
	if m.ID != 0 {
		n += 1 + sovBep(uint64(m.ID))
...
func (m *EncryptedIndex) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EncryptedIndex: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EncryptedIndex: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.Files = append(m.Files, EncryptedFileInfo{})
			if err := m.Files[len(m.Files)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *EncryptedIndexUpdate) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EncryptedIndexUpdate: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EncryptedIndexUpdate: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *EncryptedFileInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EncryptedFileInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EncryptedFileInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EncryptedFileinfo", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EncryptedFileinfo = append(m.EncryptedFileinfo[:0], dAtA[iNdEx:postIndex]...)
			if m.EncryptedFileinfo == nil {
				m.EncryptedFileinfo = []byte{}
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NumBlocks |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *EncryptedRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EncryptedRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EncryptedRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *EncryptedResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EncryptedResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EncryptedResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
var fileDescriptorBep = []byte{
	...
	,
}
