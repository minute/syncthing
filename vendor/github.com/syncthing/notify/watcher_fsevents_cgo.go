...
// registered.
var source = C.CFRunLoopSourceCreate(0, 0, &C.CFRunLoopSourceContext{
...
func (s *stream) Start() error {
	...
	wg.Wait()
	p := C.CFStringCreateWithCStringNoCopy(0, C.CString(s.path), C.kCFStringEncodingUTF8, 0)
	path := C.CFArrayCreate(0, (*unsafe.Pointer)(unsafe.Pointer(&p)), 1, nil)
