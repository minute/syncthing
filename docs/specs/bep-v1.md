Block Exchange Protocol v1 {#bep-v1}
==========================
...
The **modified\_by** field holds the short id of the client that last
...
An implementation MUST therefore accept files with a block size
